...
const Contacts = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:9090/departamentos") // Reemplaza "http://ruta-de-tu-api.com/pacientes" con la URL de tu API
      .then((response) => {
  ...
  const handleEstadoButtonClick = (row) => {
    ...
    axios
      .put(`http://localhost:9090/departamentos/${id}`, updatedData)
      .then((response) => {
