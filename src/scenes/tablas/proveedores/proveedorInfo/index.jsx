...
const Contacts = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:9090/proveedores") // Reemplaza "http://ruta-de-tu-api.com/pacientes" con la URL de tu API
      .then((response) => {
  ...
  const handleEstadoButtonClick = (row) => {
    ...
    axios
      .put(`http://localhost:9090/proveedores/${id}`, updatedData)
      .then((response) => {
