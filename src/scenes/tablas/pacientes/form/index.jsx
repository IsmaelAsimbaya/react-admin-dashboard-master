...
const Form = () => {
  ...
  return (
    <Box m="20px">
      <Header title="CREAR PACIENTE" subtitle="Crear un nuevo Perfil de Paciente" />
        ...
        {({
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              ...
              <InputLabel htmlFor="sexo_pac-select" sx={{ fontSize: 18 }}>Sexo</InputLabel>                <Select
