...
const Contacts = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://cloud-service-leonardo13344.cloud.okteto.net/laboratorios") // Reemplaza "http://ruta-de-tu-api.com/pacientes" con la URL de tu API
      .then((response) => {
  ...
  const handleEstadoButtonClick = (row) => {
    ...
    axios
      .put(`https://cloud-service-leonardo13344.cloud.okteto.net/laboratorios/${id}`, updatedData)
      .then((response) => {
