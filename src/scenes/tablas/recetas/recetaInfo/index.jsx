...
const Contacts = () => {
  ...
  navigate(`/actReceta/${id_rece}/${duracionD_rece}/${duracionM_rece}/${duracionA_rece}/${comentarios_rece}
  /${motivos_rece}/${via_administracion_rece}/${id_consulta_rece}/${estado_rece}`); 
  }
  useEffect(() => {
  ...
  const handleEstadoButtonClick = (row) => {
    ...
    const updatedEstadoRece = !row.estado_rece;
    ...
    const updatedData = {
      ...
      estado_rece: updatedEstadoRece, // Use the updated estado_pac value
    };
    ...
    axios
      ...
      .then((response) => {
        ...
        const updatedRows = rows.map((r) => {
          if (r.id === row.id) {
            return { ...r, estado_rece: updatedEstadoRece };
          }
          return r;
        });
        setRows(updatedRows);
  ...
  const columns = [
    ...
    {
      field: "id_consulta_rece",
      headerName: "ID Consulta",
      flex: 1,
      cellClassName: "name-column--cell",
    },
    {
      field: "duracionD_rece",
      headerName: "Duracion D",
      flex: 1,
    },
    {
      field: "duracionM_rece",
      headerName: "Duracion M",
      flex: 1,
    },
    {
      field: "duracionA_rece",
      headerName: "Duracion A",
      flex: 1,
    },
    {
      field: "motivos_rece",
    ...
    {
      field: "via_administracion_rece",
      headerName: "Via Administracion",
      flex: 1,
    },
    {
      field: "comentarios_rece",
    ...
    },
    {
      ...
      flex: 1,
      renderCell: ({ row }) => {
        const buttonColor = row.estado_rece ? color.greenAccent[600] : color.red[600];
        return (
  ...
  return (
    <Box m="20px">
      <Header
        title="RECETA"
        subtitle="Lista de Recetas registradas"
      />
      <Box
        m="40px 0 0 0"
        height="75vh"
